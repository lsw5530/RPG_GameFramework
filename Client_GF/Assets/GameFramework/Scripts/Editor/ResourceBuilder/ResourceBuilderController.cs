    ...
    public sealed partial class ResourceBuilderController
    {
        ...
        private bool BuildResources(Platform platform, AssetBundleBuild[] assetBundleBuildMap, BuildAssetBundleOptions buildAssetBundleOptions, BinaryBuild[] binaryBuildMap)
        {
            ...
            if (OutputFullSelected)
            {
                ...
                m_BuildReport.LogVersionInfo(BuildReportPath, platformName, ApplicableGameVersion, InternalResourceVersion, versionListData.Path, versionListData.Length, versionListData.HashCode, versionListData.ZipLength, versionListData.ZipHashCode);
