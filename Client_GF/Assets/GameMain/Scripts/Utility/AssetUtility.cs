...
namespace StarForce
{
    public static class AssetUtility
    {
        ...
        public static string GetResCfgsAsset(string assetName) {
            return Utility.Text.Format("Assets/GameMain/XmlCfgs/{0}.xml", assetName);
        }
        public static string GeSpritAsset(string assetName) {
            return Utility.Text.Format("Assets/GameMain/UI/UISprites/Sprites/{0}.png", assetName);
        }
        public static string GeUIPrefabAsset(string assetName) {
        ...
        public static string GetLuaAsset(string assetName) {
            ...
            return Utility.Text.Format("Assets/GameMain/Lua/{0}.txt", assetName);
        }
    }
}
